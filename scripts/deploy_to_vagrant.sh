...
scp -F /tmp/cfg.txt $script_base/../folio-demo-module/build/libs/mod-grails-demo-0.0.1.war default:
...
vagrant ssh -c "sudo mv mod-grails-demo-0.0.1.war /home/folio/mod-grails-demo.war"
vagrant ssh -c "sudo mv folio_globals.yaml /home/folio/folio_globals.yaml"

echo CHOWN phase
# Chown all the files just copied to folio:folio
vagrant ssh -c "sudo chown folio:folio /etc/folio/deployment-descriptors/mod-grails-demo.json /etc/folio/module-descriptors/mod-grails-demo.json /home/folio/mod-grails-demo.war /home/folio/folio_globals.yaml"
